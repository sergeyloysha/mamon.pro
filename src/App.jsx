    ...
    return (
      <div className="wrapper">
        <div className="page">
                ...
                <div className="row">
                  <div className="col-md-6">
                    <div className="card card_clear">
                      ...
                      <div className="card__description">
                        So many good teams fail because of poor planning and
                        lack of communications. We keep you aligned with our
                        team - every day, week and month. So you know what’s
                        going on at every of your project.
                      </div>
                      <div className="card__images">
                        <div className="card__image" style={{ width: "8rem" }}>
                          <img
                            src="/assets/images/icon-trello-black.svg"
                            alt=""
                          />
                        </div>
                        <div className="card__image" style={{ width: "10rem" }}>
                          <img
                            src="/assets/images/icon-slack-black.svg"
                            alt=""
                          />
                        </div>
                      </div>
                      ...
                      <div className="messages__list">
                        <div className="messages__item">
                          <div className="messages__message">
                            Hello Sergey, how things are going?
                          </div>
                        </div>
                        <div className="messages__item">
                          <div className="messages__message messages__message_my">
                            Hey, everything is going well. We’re already
                            delivered the design.
                          </div>
                        </div>
                        <div className="messages__item">
                          <div className="messages__message">
                            Coooool, let me check.
                          </div>
                        </div>
                        <div className="messages__item">
                          <div className="messages__message messages__message_my">
            ...
            <div className="section__content">
              <div className="collage">
                <div
                  ...
                  style={{ width: "189px", left: "-0.0694444%", top: "175px" }}
                >
                  <img
                    src="https://d2998a9lzvovjv.cloudfront.net/collage-1@1x.c7b776f8.png"
                    alt=""
                  />
                </div>
                <div
                ...
                >
                  <img
                    src="https://d2998a9lzvovjv.cloudfront.net/collage-2@1x.3c561a1a.png"
                    alt=""
                  />
                </div>
                <div
                  className="collage__item collage__item_new"
                  style={{
                    width: "576px",
                    left: "37.2917%",
                    top: "325px",
                ...
                >
                  <img
                    src="https://d2998a9lzvovjv.cloudfront.net/collage-5@1x.690c7042.png"
                    alt=""
                  />
                </div>
                <div
                ...
                <div
                  className="collage__item"
                  style={{ width: "400px", left: "15.4167%", top: "454px" }}
                >
                ...
                >
                  <img
                    src="https://d2998a9lzvovjv.cloudfront.net/collage-8@1x.13f5e54b.png"
                    alt=""
                  />
                </div>
                <div
                  className="collage__item"
                  style={{ width: "450px", left: "70%", top: "260px" }}
                >
                  <img src="/assets/images/projects/2.png" alt="" />
                </div>
                <div
                  className="collage__item"
                  style={{ width: "532px", left: "72.4306%", top: "462px" }}
                >
                  <img
                    src="https://d2998a9lzvovjv.cloudfront.net/collage-10@1x.f47f643e.png"
                    alt=""
                  />
                </div>
                <div
                ...
                >
                  <img
                    src="https://d2998a9lzvovjv.cloudfront.net/collage-11@1x.f37e4bc7.png"
                    alt=""
                  />
                </div>
                <div
                ...
                >
                  <img
                    src="https://d2998a9lzvovjv.cloudfront.net/collage-12@1x.ef192dcb.png"
                    alt=""
                  />
                </div>
                <div
                ...
                >
                  <img
                    src="https://d2998a9lzvovjv.cloudfront.net/collage-13@1x.db41a61f.png"
                    alt=""
                  />
                </div>
                <div
                  className="collage__item"
                  style={{ width: "68px", left: "58.0556%", top: "23px" }}
                >
                  <img
                    src="https://d2998a9lzvovjv.cloudfront.net/collage-14@1x.89ac75ec.png"
                    alt=""
                  />
                </div>
                <div
                  className="collage__item"
                  style={{ width: "48px", left: "59.7222%", top: "108px" }}
                >
                  <img
                    src="https://d2998a9lzvovjv.cloudfront.net/collage-15@1x.bdbfe07b.png"
                    alt=""
                  />
                </div>
                <div
                  className="collage__item"
                  style={{ width: "391px", left: "64.2361%", top: "31px" }}
                >
                  <img
                    src="https://d2998a9lzvovjv.cloudfront.net/collage-16@1x.9c0e3cac.png"
                    alt=""
                  />
                </div>
                <div
                ...
                >
                  <img
                    src="https://d2998a9lzvovjv.cloudfront.net/collage-17@1x.9d568820.png"
                    alt=""
                  />
                </div>
                <div
                  className="collage__item"
                  style={{ width: "250px", left: "44.375%", top: "659px" }}
                >
                  <img
                    src="https://d2998a9lzvovjv.cloudfront.net/collage-18@1x.be742367.png"
                    alt=""
                  />
                </div>
              </div>
          ...
          <section
            className="section section_gray"
            style={{ borderTop: "1px solid #e1eaf0" }}
          >
            <div className="container">
              <div className="section__content">
                <div className="row">
                  <div className="col-md-8 col-md-offset-2">
                    <div className="testimonial">
                      <div className="testimonial__text">
                        Mamon is one of the best front-end teams we have worked
                        with. Their work has the power to change your business.
                      </div>
                      <div className="testimonial__author">
                        <div className="testimonial__author-photo">
                          <img
                            src="/assets/images/testimonials/angela-w.jpeg"
                            alt="Angela Wiesenmüller"
                          />
                        </div>
                  ...
                  <div className="col-md-8 col-md-offset-2">
                    <div className="card card_center card_clear">
                      ...
                      <div className="card__text">
                        We would love for you to tell us more about your
                        product; what it’s about and what you believe needs
                        improvement.
                      </div>
                      <div className="card__button">
                        <a className="button" href="mailto:hello@mamon.pro">
                          Let's chat
                        </a>
                      </div>
                    </div>
            ...
            <div className="footer__inner">
              ...
              <div className="footer__bottom">
                <div className="footer__address">
                  st. September 17th, Grodno, Belarus
                </div>
                <div className="footer__social">
                  <div className="social">
                    <a
                      className="social__item"
                      href="//www.facebook.com/mamonprohq/"
                    >
                    ...
                    <a
                      className="social__item"
                      href="//www.linkedin.com/company/mamon/"
                    >
                      <div className="social__icon">
